...
Esta entrega se nos hizo bastante pesada ya que quisimos tener avanzado lo mayor posible para la entrega final. Estuvimos muchos días escribiendo y creando la webstory. Aún faltan ciertas cosas que arreglar, pero sentimos que vamos bien encaminadas.
 ...
 Estamos muy orgullosas del trabajo que hemos creado a lo largo del semestre, hemos aprendido mucho.
...
Siguiendo con las demás visualizaciones, las tres restantes fueron realizadas en Fluorish. la primera de ellas, entrega datos en un  mapa mundial por cada país del índice del mal manejo de plásticos, el nivel de mal manejo de plásticos, que va de muy bajo a muy alto, y finalmente el consumo total de plásticos por país en toneladas.
...
- **Visualización de barras horizontales de Flourish:**
Países:China, Alemania, Francia, España, India, Brasil y Estados Unidos.
Tipos de bolsas usadas: reutilizables, de plástico, de papel, sin bolsa.
Porcentaje de uso según el tipo de bolsa: porcentaje de emisión de bolsas según su tipo y desglosada por cada categoría en cada país.
...
- **Dentro de la webstory** como ya hemos mencionado antes utilizamos distintos elementos que complementan nuestra información, los cuales van tomando forma dentro de la página relacionándose entre sí. Por ejemplo cuando hablamos de las ONG, se ve un video e imágenes de las distintas organizaciones y luego cada una con su respectivo botón que lleva a las páginas oficiales de ellas.   

- **A lo largo del reportaje**, los usuarios se irán dando cuenta que efectivamente las distintas leyes y proyectos de ONG han ayudado en el impacto de las bolsas plásticas en el océanos, por lo que nuestra hipótesis se confirma. También por otro lado las preguntas se van a poder ir contestando, ya que toda la información estará presente dentro de nuestra web story. Los gráficos de los países, las infografías y el video presentado brindaran información que dará consistencia y claridad a nuestra historia.  

- **Sobre la capacidad comunicativa del mensaje**, para  nuestra a web store, elegimos varios elementos para que el mensaje pudiese ser transmitido de manera clara, que impacte y entretenida. Es por eso que en primer lugar utilizamos texto. Este fue diseñado para ser preciso pero informativo. Con el objetivo de entregar los datos más importantes de manera clara y accesible. Para nosotras, este elemento tiene como intención complementar los otros elementos, guiando al espectador con explicaciones fáciles y bien estructuradas, sin cargarlo con exceso. 

Por otro lado, consideramos muy importante hacer un buen uso de las imágenes, más que decorativas, queremos que estas acompañen la historia. No solo son fotografías, sino que en estas agregamos infografía de leyes, gráficos e imágenes que muestran cómo se ven las playas actualmente. Con estos elementos, el espectador es capaz de recibir el mensaje de manera más clara, ya que puede hacerse una visión real de lo que estamos hablando, y captar el mensaje como queremos que lo vea. 

Lo mismo con la utilización de videos. Sabemos que mucho texto a veces puede ser cansador, entonces igual quisimos poder un video que mostrará cómo limpiar los océanos, así se explica de forma directa y hace que el mensaje sea más entretenido y fácil de entender. 
En tercer lugar, los gráficos son un elemento muy importante para nosotras para comunicar nuestro mensaje. Al ser un reportaje que tiene tantos países, cifras y toneladas, la manera más llamativa de presentar esa información es con gráficos. De esta forma no se pierden los datos y cifras objetivas, pero permite visualizar la magnitud del problema de una manera más clara. Además, teniendo los datos ahí, el espectador es capaz de generar su propia visión sobre lo que está viendo. 

Por último, sabemos que a veces la información que proporcionamos puede no quedar tan clara para todo público, entonces nuestra página web incluyen botones que linkean directo a páginas. De esta forma busca garantizar que el mensaje sea comprendido o también para complementar lo que nosotros decimos.  
